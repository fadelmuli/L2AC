...
# train path
#NN_MODEL = None
NN_MODEL = '/content/drive/MyDrive/L2AC/AC_results_2/nn_model_ep_49.ckpt' #  can load trained model
...
LOG_FILE_PATH = '/content/log/test'
        ...
        for video in VIDEO_TRACE_list:
            ...
            while True:
                ...
                if decision_flag or end_of_video:
                    ...
                    la_action = L_actor.choose_action(state)  # latency network action
